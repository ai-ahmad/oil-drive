...
const HomeContent = () => {
  ...
  // const category_products = JSON.parse(localStorage.getItem('category_products'));
  // console.log(category_products)
  // const filtered_products = category_products.length 
  //   ? products.filter(item => item.category === category_products) 
  //   : products;
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {products.map((product) => (
          <div
            ...
            onClick={() => handleCardClick(product)} // Click handler for the card
          >
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center justify-between mt-2">
                <span className="text-sm sm:text-base flex items-center">
                  ...
                  {product.volume && product.volume.length > 0 ? `${product.volume[0]} л` : "Нет данных"}
                </span>
          ...
          <div className="bg-white rounded-lg p-6 max-w-[800px] w-full mx-auto shadow-lg relative">
            ...
            <div className="flex flex-col md:flex-row mt-4">
              ...
              <div className="ml-0 md:ml-6">
                ...
                <p className="font-bold text-lg mb-2">
                  Объем: <span className="font-normal">{selectedProduct.volume && selectedProduct.volume.length > 0 ? selectedProduct.volume[0] : "Нет данных"} л</span>
                </p>
                <p className="font-bold text-lg mb-2">
