...
<p className="mb-4">Обращайтесь по указанным данным ниже, мы обязательно с Вами все обсудим.</p>
<p className="mb-6">Либо закажите обратный звонок в правом верхнем углу сайта, мы обязательно Вам перезвоним.</p>

<div className="space-y-2 mb-6">
  <p><strong>Наш адрес:</strong> Узбекистан, г.Ташкент, Ул. Полевая (Ориентир Аэропорт)</p>
  <p><strong>Телефон/Telegram:</strong> +998 99 797 48 77 (Руководитель отдела продаж) Джексанбаев Арслан Русланович</p>
  <p><strong>Телефон/Telegram:</strong> +998 90 324 45 56 (Менеджер по вопросам закупок) Чоудри Али Сергеевич</p>
  <p><strong>Телефон/Telegram:</strong> +998 99 837-25-70 (Директор по развитию) Владлена</p>
  <p><strong>Телефон/Telegram:</strong> +998 90 000 00 00 (Заведующий складом) А.А</p>
  <p><strong>Email:</strong> oiltrade.uz@mail.ru</p>
</div>

        {/* Рендер карты только после монтирования компонента */}
        {isMounted && (
          <div className="w-full h-96 mt-6"> {/* Измените высоту здесь */}
